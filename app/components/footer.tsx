...
const Footer = (props: FooterComponentProps) => {
    ...
    return (
        ...
        <div className="max-w-[84rem] mx-auto pt-[6rem] pb-[4rem]
                            ">
            <div className="grid grid-cols-6 gap-[1.5rem]">
                {items.map((val, i) => {
                    return (
                        <div className={`${i === 0 ? "col-span-2" : "col-1"} text-[#8AA1CB] text-[20px] gap-[2rem]`}>
                            <div className="font-helvethaica contrast-[2.1]">
                                {i === 0 ? <img className="w-[11rem]" src={val.url} alt="" /> : val.label}
                            </div>
                            <div className={` ${i === 0 ? "font-helvethaica" : "font-helvethaica-bd"}  mt-[1.5rem]`}>
            ...
            <div className="pt-[2.5rem]">
                <hr className="border-[#8AA1CB] pt-[2.5rem]" />
                <div className="justify-between flex">
                    <div className="text-[#8AA1CB] font-helvethaica">Copyright © 2024 N Health. All rights reserved.</div>
                    <div className="text-[#8AA1CB] flex">
                        <div className="px-3 font-helvethaica">
                            คอลเซ็นเตอร์ (66) 2762 4000
                        </div>
                        <div className="px-3">
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className="Icon " height="1.7em" width="1.7em" xmlns="http://www.w3.org/2000/svg">
